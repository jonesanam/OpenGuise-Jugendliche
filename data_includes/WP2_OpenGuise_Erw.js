    ...
    newImage("HU","HU Logo.png")  
        ...
        ,
         newCanvas("Logosnebeneinander",1138,100) //bildet den Header mit Logos
            ...
            .print()
        ,
newText("erkannt?","<b>Hattest du das Gefühl, die Person, die du eben gehört hast, persönlich zu kennen?</b><br><small>(Falls ja: Was glaubst du, wer es ist?)</small><br><br>")
